    ...
    <section class="admin-grid">
      <div class="admin-section">
        ...
        <div class="shipping-form">
          ...
          ${settingsField("printer_connection", "اتصال الطابعة: windows_default / windows_named / mock", printer.connection || "windows_default")}
          ...
          <label class="toggle-row">
            <input type="checkbox" id="ship-live-create" ${settings.live_create_enabled ? "checked" : ""}>
            <span>تفعيل إنشاء الشحنة فعليًا داخل AJEX</span>
          </label>
          <label class="toggle-row">
            <input type="checkbox" id="ship-auto-print" ${settings.auto_print_enabled ? "checked" : ""}>
            <span>طباعة تلقائية عند إنشاء البوليصة</span>
          </label>
...
async function saveShippingSettings() {
  const body = {
    ...
    live_create_enabled: Boolean(document.getElementById("ship-live-create")?.checked),
    ...
    printer: {
      ...
      connection: document.getElementById("ship-printer_connection")?.value || "windows_default"
    },
    sender: {
